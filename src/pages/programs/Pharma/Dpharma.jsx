...
import {
  ...
  FaBookOpen,
  FaBriefcase,
  FaPills, // Main icon for Pharmacy
  FaMedkit, // For general health/first aid
  ...
  FaUserMd, // For patient interaction
  FaBuilding, // For hospital/clinic setting
...
const DPharmaPage = () => {
  ...
  const careerPaths = [
    ...
    {
      title: "Dispenser",
      description: "Prepare and issue prescribed medications under the supervision of a pharmacist.",
      icon: <FaUserMd className='w-6 h-6 text-teal-600' />,
    },
    {
      title: "Drug Store Manager",
      description: "Oversee daily operations, inventory, and staff in a retail drug store.",
      icon: <FaBuilding className='w-6 h-6 text-indigo-600' />,
    },
    {
      title: "Medical Representative Assistant",
      description: "Support sales teams in promoting pharmaceutical products.",
  ...
  <meta name="description" content="Start your career in pharmacy with a D.Pharm diploma from Saroj International University, focusing on pharmaceutical fundamentals and practical skills." />
      ...
      <div className='max-w-6xl mx-auto px-4 py-12'>
        <div className='text-center mb-16'>
          ...
          <h1 className='text-4xl md:text-5xl font-bold text-gray-800 mb-4'>Diploma in Pharmacy (D.Pharm)</h1>
          <p className='text-xl text-gray-600 max-w-3xl mx-auto'>A practical-oriented program for aspiring pharmacy assistants and technicians, focusing on dispensing and patient support.</p>
        </div>
        ...
        <div className='grid grid-cols-1 md:grid-cols-3 gap-6 mb-16'>
          <div className='bg-white p-6 rounded-lg shadow-md border border-gray-100'>
            ...
            <p className='text-gray-700'>Diploma in Pharmacy (D.Pharm)</p>
          </div>
        ...
        <div className='bg-white rounded-lg shadow-md overflow-hidden mb-12'>
          ...
          {expandedSections.overview && (
            <div className='px-6 pb-6'>
              <p className='text-gray-700 mb-4'>The D.Pharm program is a two-year diploma course designed to train individuals as pharmacy assistants and technicians. It focuses on practical aspects of dispensing medications, managing drug stores, and assisting pharmacists in various healthcare settings.</p>
              <p className='text-gray-700 mb-4'>This program is ideal for students seeking a quicker entry into the pharmaceutical sector, providing essential skills for roles in retail pharmacies, hospitals, and clinics.</p>
              <div className='mt-6'>
                <h3 className='font-semibold text-lg mb-3 text-gray-800'>Key Learning Outcomes:</h3>
                <ul className='space-y-2 text-gray-700'>
                  <li className='flex items-start'>
                    <span className='mr-2'>•</span>
                    <span>Basic understanding of pharmacology and drug classification.</span>
                  </li>
                  <li className='flex items-start'>
                    <span className='mr-2'>•</span>
                    <span>Skills in drug dispensing, storage, and inventory management.</span>
                  </li>
                  <li className='flex items-start'>
                    <span className='mr-2'>•</span>
                    <span>Knowledge of pharmaceutical laws and ethics.</span>
                  </li>
                  <li className='flex items-start'>
                    <span className='mr-2'>•</span>
                    <span>Ability to provide basic patient support and information.</span>
                  </li>
                </ul>
              </div>
            </div>
        ...
        <div className='bg-white rounded-lg shadow-md overflow-hidden mb-12'>
          ...
          {expandedSections.careers && (
            <div className='px-6 pb-6'>
              ...
              <div className='mt-8'>
                <h3 className='font-semibold text-lg mb-3 text-gray-800'>Top Employers:</h3>
                <div className='flex flex-wrap gap-4'>
                  {["Retail Pharmacies", "Hospital Pharmacies", "Community Health Centers", "Drug Distributors", "Private Clinics"].map((company, i) => (
              ...
              <div className='grid grid-cols-1 md:grid-cols-2 gap-8'>
                <div>
                  ...
                  <ul className='space-y-3 text-gray-700'>
                    <li className='flex items-start'>
                      <span className='mr-2'>•</span>
                      <span>10+2 with Physics, Chemistry, and Biology/Mathematics or equivalent</span>
                    </li>
                    <li className='flex items-start'>
                      <span className='mr-2'>•</span>
                      <span>Minimum 45% aggregate marks</span>
                    </li>
                  </ul>
                </div>
                <div>
                  ...
                  <ol className='space-y-3 text-gray-700 list-decimal list-inside'>
                    ...
                    <li>Provide academic and identification documents.</li>
                    <li>Pay application fee.</li>
                    <li>Counseling and admission offer.</li>
                  </ol>
                </div>
              </div>
        ...
        <div className='text-center bg-green-700 text-white p-12 rounded-lg'>
          ...
          <p className='text-xl mb-8 max-w-2xl mx-auto'>Enroll in our D.Pharm program for a practical pathway into the pharmaceutical industry.</p>

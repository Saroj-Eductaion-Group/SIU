...
        "Minimum aggregate percentage as per university norms." // Added a second eligibility point for completeness
      ],
      fee: {
        annual: "₹75,000",
...
        {/* Programs Section - Includes Eligibility and Fees details */}
...
                  className="bg-gray-50 p-8 rounded-xl shadow-lg hover:shadow-xl transition duration-300 border-t-4 border-blue-600 mb-8"
                >
                  <motion.div 
...
                  
                  {/* Program Features */}
                  <h4 className="text-xl font-semibold mb-3 text-blue-700">Key Features:</h4>
...
                  {/* Eligibility Section for this program */}
                  <h4 className="text-xl font-semibold mb-3 text-blue-700 flex items-center"><FaUserCheck className="mr-2"/>Eligibility Criteria:</h4>
...
                  </ul>
                  
                  {/* Program Fees Section - MOVED FROM DEDICATED SECTION */}
                  <div className='p-6 bg-blue-100 rounded-lg border-l-4 border-blue-600 mb-8'>
                    <h4 className="text-xl font-semibold mb-3 text-blue-800 flex items-center">Annual Fee Structure:</h4>
...
                      className='flex items-center justify-center bg-blue-600 hover:bg-blue-700 text-white font-semibold px-8 py-3 rounded-full transition duration-300 shadow-lg hover:shadow-xl'
                    >
                      Apply Now
...
        {/* The fees section content has been integrated into the programs card. */}
        
        {/* Faculty Section */}

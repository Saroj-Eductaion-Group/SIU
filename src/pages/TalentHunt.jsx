      ...
      <div className="bg-white rounded-2xl w-full max-w-md shadow-2xl relative my-auto" style={{maxHeight:'90vh',overflowY:'auto'}}>
        ...
        <div className="p-5 sm:p-6">
          ...
          <div className="grid grid-cols-2 gap-2 mb-4">
            {[
              ['🏆','100% Scholarship','Score 90% or above','bg-yellow-50 border-yellow-300 text-yellow-800'],
...
export default function TalentHunt() {
  ...
  useEffect(() => {
    ...
    if (!seen) {
      const t = setTimeout(() => {
        setShowSchPopup(true);
        sessionStorage.setItem('th_sch_seen', '1');
      }, 1500);
